...
import 'package:neumorphism_calculator/provider/calculation_provider.dart';
  ...
  Widget build(BuildContext context) {
    ...
    return Listener(
      ...
      child: AnimatedContainer(
        ...
        decoration: BoxDecoration(borderRadius: borderRadius, shape: shape, color: kPrimaryColor, boxShadow: [
          BoxShadow(
          ...
          BoxShadow(
            offset: const Offset(2, 2),
            blurRadius: 5,
            color: isPressed ? Colors.transparent : const Color(0xACFFFFFF),
            inset: true,
          ),
          BoxShadow(
            offset: const Offset(-2, -2),
